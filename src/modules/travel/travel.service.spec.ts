...
describe('TravelService', () => {
  ...
  describe('find all travels', () => {
    it('should find the travels based on the search input', async () => {
      ...
      travelRepository.findAndCount.mockResolvedValue([mockTravels, mockTravels.length]);
  ...
  describe('remove travel by id', () => {
    it('should remove the travel by id and return true', async () => {
      ...
      const result = await service.remove('d408be33-aa6a-4c73-a2c8-58a70ab2ba4d');
  ...
  describe('update travel', () => {
    it('should update travel data', async () => {
      ...
      travelRepository.save.mockResolvedValue({...mockTravels[0], ...updateTravelInput});
      const result = await service.update('d408be33-aa6a-4c73-a2c8-58a70ab2ba4d', updateTravelInput);
